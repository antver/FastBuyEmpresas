...
public class RecepcionFragment extends Fragment {
    ...
    public static RecepcionFragment instance;
    public static RecepcionFragment newInstance() {
        if(instance == null)
            instance = new RecepcionFragment();
        return instance;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_recepcion, container, false);
...
//981293432
                            ...
                            if(pendiente.getInt("atendido") == 0 || pendiente.getInt("atendido") == 4)
                                list.add(pedido);
                        }
